...
@section('title', 'Ubah Klaster')
@section('header', 'Ubah Klaster')
...
@section('content')
    <form method="POST" action="{{ route('master.klaster.update', $klaster) }}" class="mx-auto max-w-3xl space-y-6">
        @csrf
        @method('PUT')
        <div class="card p-6">
            ...
            @include('master.klaster._form', ['klaster' => $klaster])
        </div>
